        ...
        <div class="checkout-content">
            ...
            <div class="card product-summary">
                ...
                <div class="product-details">
                    ...
                    <p><strong>Category:</strong><br><?php echo htmlspecialchars($product['category'] ?? 'N/A'); ?></p>
            ...
            <div class="card checkout-form">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <?php $max_quantity = max(1, $product['quantity_available']); ?>
                        <input type="number" id="quantity" name="quantity" min="1" max="<?php echo $max_quantity; ?>" value="<?php echo $quantity; ?>" required onchange="updateTotal()">
